...
<html lang="en">
    <head>
        ...
        <title>Developing Basa - Dashboard</title>
        ...
        <script src="{{ asset('backend/calendar/fullcalendar.js') }}"></script>
				<script src="{{ asset('backend/calendar/script.js') }}"></script> --}}
     ...
     <link rel="stylesheet" type="text/css" href="{{ asset('backend/css/toastr.css') }}" >
      ...
      <body class="hold-transition light-skin sidebar-mini theme-primary fixed">
        ...
        <script src="{{ asset('backend/js/sweetalert2@10.js') }}"></script>
